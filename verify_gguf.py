...
EXPECTED = {
    ...
    "general.name": "XGLM-2.9B",
    "xglm.block_count": 48,
    "xglm.context_length": 2048,
    "xglm.embedding_length": 2048,
    "xglm.feed_forward_length": 8192,
    "xglm.attention.head_count": 16,
    "xglm.embedding_scale": 45.25483322143555,
...
def main():
    ...
    if tensor_count != 580:
        errors.append(f"tensor_count: expected 580, got {tensor_count}")
